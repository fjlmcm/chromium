Once the source code is released, follow the ungoogled-chromium build documentation, but replace its submodule URL with the fingerprint-browser repository URL.
